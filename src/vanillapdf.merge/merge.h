#ifndef _VANILLAPDF_MERGE_H
#define _VANILLAPDF_MERGE_H
...
extern const int VANILLAPDF_MERGE_ERROR_SUCCESS;
extern const int VANILLAPDF_MERGE_ERROR_INVALID_PARAMETERS;
extern const int VANILLAPDF_MERGE_ERROR_FAILURE;
...
do { \
	...
	{ \
		...
		return VANILLAPDF_MERGE_ERROR_FAILURE; \
	} \
} while(0)
