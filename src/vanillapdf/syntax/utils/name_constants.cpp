...
DECLARE_CONST_NAME(GoTo);
DECLARE_CONST_NAME(GoToR);
DECLARE_CONST_NAME(Index);
DECLARE_CONST_NAME(Kids);
DECLARE_CONST_NAME(Lang);
DECLARE_CONST_NAME(Launch);
...
DECLARE_CONST_NAME(AuthEvent);
DECLARE_CONST_NAME(DocOpen);
DECLARE_CONST_NAME(EncryptMetadata);
DECLARE_CONST_NAME(OE);
DECLARE_CONST_NAME(UE);
...
DECLARE_CONST_NAME(RunLengthDecode);
DECLARE_CONST_NAME(JS);
DECLARE_CONST_NAME(JPXDecode);
DECLARE_CONST_NAME(JavaScript);
...
DECLARE_CONST_NAME(NeedAppearances);
DECLARE_CONST_NAME(DV);
DECLARE_CONST_NAME(TU);
DECLARE_CONST_NAME(Opt);
DECLARE_CONST_NAME(MaxLen);
DECLARE_CONST_NAME(AP);
DECLARE_CONST_NAME(AS);
...
DECLARE_CONST_NAME(DP);
DECLARE_CONST_NAME(AHx);
DECLARE_CONST_NAME(A85);
DECLARE_CONST_NAME(LZW);
DECLARE_CONST_NAME(Fl);
DECLARE_CONST_NAME(RL);
DECLARE_CONST_NAME(CCF);
DECLARE_CONST_NAME(DCT);
...
DECLARE_CONST_NAME(QuadPoints);
DECLARE_CONST_NAME(DA);
DECLARE_CONST_NAME(Q);
DECLARE_CONST_NAME(Open);
DECLARE_CONST_NAME(IC);
DECLARE_CONST_NAME(InkList);
DECLARE_CONST_NAME(Form);
DECLARE_CONST_NAME(FormType);
DECLARE_CONST_NAME(PS);
DECLARE_CONST_NAME(BBox);
DECLARE_CONST_NAME(Matrix);
DECLARE_CONST_NAME(MK);
DECLARE_CONST_NAME(DR);

// Appearance characteristics dictionary entries, see Table 189
DECLARE_CONST_NAME(BC);
DECLARE_CONST_NAME(BG);
DECLARE_CONST_NAME(CA);
DECLARE_CONST_NAME(RC);
DECLARE_CONST_NAME(AC);
