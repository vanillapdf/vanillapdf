...
MessageDigestAlgorithm SigningOptions::GetDigest() const {
	return m_digest;
}

void SigningOptions::SetDigest(MessageDigestAlgorithm digest) {
	m_digest = digest;
}

bool SigningOptions::GetSigningKey(OutputPointer<ISigningKeyPtr>& result) const {
	if (m_key.empty()) {
		return false;
	}
...
bool SigningOptions::GetCertificate(OutputPointer<HexadecimalStringObjectPtr>& result) const {
...
bool SigningOptions::GetName(OutputPointer<LiteralStringObjectPtr>& result) const {
	if (m_name.empty()) {
		return false;
	}
...
bool SigningOptions::GetLocation(OutputPointer<LiteralStringObjectPtr>& result) const {
	if (m_location.empty()) {
		return false;
	}
...
bool SigningOptions::GetReason(OutputPointer<LiteralStringObjectPtr>& result) const {
	if (m_reason.empty()) {
		return false;
	}
...
void SigningOptions::SetSigningKey(ISigningKeyPtr value) {
	m_key = value;
}

void SigningOptions::SetCertificate(HexadecimalStringObjectPtr value) {
	m_certificate = value;
}

void SigningOptions::SetName(LiteralStringObjectPtr value) {
	m_name = value;
}

void SigningOptions::SetLocation(LiteralStringObjectPtr value) {
	m_location = value;
}

void SigningOptions::SetReason(LiteralStringObjectPtr value) {
	m_reason = value;
}
