...
namespace gotchangpdf
{
	namespace syntax
	{
		...
		class XrefTableSubsectionsGrammar : public qi::grammar<pos_iterator_type,
			XrefBasePtr(std::shared_ptr<File>*, types::stream_offset)>
		{
		public:
			XrefTableSubsectionsGrammar();

		private:
			qi::rule<pos_iterator_type, XrefBasePtr(std::shared_ptr<File>*, types::stream_offset)> start;
			...
			qi::rule<pos_iterator_type, XrefEntryBasePtr(types::integer), qi::locals<types::integer, types::ushort>> entry;
