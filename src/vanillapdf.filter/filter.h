#ifndef _VANILLAPDF_FILTER_H
#define _VANILLAPDF_FILTER_H
...
extern const int VANILLAPDF_FILTER_ERROR_SUCCESS;
extern const int VANILLAPDF_FILTER_ERROR_INVALID_PARAMETERS;
extern const int VANILLAPDF_FILTER_ERROR_FAILURE;
...
do { \
	...
	{ \
		...
		return VANILLAPDF_FILTER_ERROR_FAILURE; \
	} \
} while(0)
