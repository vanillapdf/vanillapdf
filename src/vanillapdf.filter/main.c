...
int main(int argc, char *argv[]) {
	...
	RETURN_ERROR_IF_NOT_SUCCESS(OutputStreamInterface_CreateFromFile(destination_file, &output_stream));
	...
	RETURN_ERROR_IF_NOT_SUCCESS(InputStreamInterface_Release(input_stream));
