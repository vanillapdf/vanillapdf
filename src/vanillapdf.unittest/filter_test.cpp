...
//
// Generated by scripts/gen_predictor_test_vectors.py and independently
// certified by Pillow (libpng) at generation time. Each INPUT_* array is a
// zlib-compressed, PNG-filtered RGB image (Colors=3, BitsPerComponent=8,
// Columns=4, 3 rows); decoding it with the matching DecodeParms must yield
// EXPECTED_RAW. The Average and Paeth filters exercise the reconstruction
// loops that historically wrote the reconstructed byte to the wrong column
// (current[i] instead of current[bytes_per_pixel + i]).

static const unsigned char INPUT_AVERAGE[] = {
    0x78, 0xDA, 0x63, 0x16, 0x50, 0x30, 0xB0, 0x75, 0xF4, 0x88, 0x88, 0x4C,
    0x4A, 0x2B, 0xAC, 0x66, 0xE6, 0x94, 0x97, 0x16, 0x95, 0x90, 0x15, 0x96,
    0x91, 0x15, 0x97, 0x17, 0x62, 0x7E, 0x71, 0x6A, 0x67, 0x76, 0x45, 0xA7,
    0x2E, 0xE7, 0x4B, 0x31, 0xC6, 0xEF, 0x00, 0xB1, 0x27, 0x0A, 0xBA,
};

static const unsigned char INPUT_PAETH[] = {
    0x78, 0xDA, 0x63, 0x11, 0x50, 0x30, 0x30, 0x35, 0x34, 0x30, 0x35, 0x30,
    0xD2, 0x34, 0x30, 0x62, 0x61, 0xE4, 0x67, 0xFE, 0xCD, 0xCE, 0xF6, 0x8D,
    0x9D, 0xFD, 0x2F, 0xD7, 0x1F, 0x96, 0xFB, 0x9B, 0xE6, 0x0B, 0x1B, 0x07,
    0xAB, 0xFD, 0x7F, 0xF4, 0x93, 0xC9, 0x18, 0x00, 0xB7, 0xB0, 0x0C, 0x45,
};
...
TEST(FlateDecodeFilter, PngPredictorAverageReconstruction) {
    DecodePngPredictorAndCompare(INPUT_AVERAGE, sizeof(INPUT_AVERAGE), EXPECTED_RAW, sizeof(EXPECTED_RAW));
}

TEST(FlateDecodeFilter, PngPredictorPaethReconstruction) {
    DecodePngPredictorAndCompare(INPUT_PAETH, sizeof(INPUT_PAETH), EXPECTED_RAW, sizeof(EXPECTED_RAW));
}
