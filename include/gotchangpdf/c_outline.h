...
extern "C"
{
	...
	//GOTCHANG_PDF_API error_type CALLING_CONVENTION OutlineItem_GetDestinations(OutlineItemHandle handle, PIntegerHandle result);
	//GOTCHANG_PDF_API error_type CALLING_CONVENTION OutlineItem_GetActions(OutlineItemHandle handle, PIntegerHandle result);
	//GOTCHANG_PDF_API error_type CALLING_CONVENTION OutlineItem_GetStructureElement(OutlineItemHandle handle, PIntegerHandle result);
