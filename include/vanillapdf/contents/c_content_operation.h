    ...
    */
    typedef enum {
        ...
        */
        ...
        ContentOperationType_SetStrokingColorSpaceName,
        ContentOperationType_SetNonstrokingColorSpaceName,
        ContentOperationType_SetStrokingColorSpaceDevice,
        ContentOperationType_SetStrokingColorSpaceDeviceExtended,
        ContentOperationType_SetNonstrokingColorSpaceDevice,
        ContentOperationType_SetNonstrokingColorSpaceDeviceExtended,
