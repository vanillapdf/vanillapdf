...
elseif(UNIX)
	...
	elseif(PACKAGE_DISTRIBUTION MATCHES "RedHat.*" OR PACKAGE_DISTRIBUTION STREQUAL "CentOS")
		...
		set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${PACKAGE_VERSION_NAME}.el${REDHAT_VERSION_MAJOR}.${PACKAGE_ARCHITECTURE}")
