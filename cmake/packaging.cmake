...
elseif(UNIX)
	...
	if(PACKAGE_ARCHITECTURE STREQUAL "arm" OR PACKAGE_ARCHITECTURE STREQUAL "armv71")
		set(PACKAGE_FILENAME_ARCHITECTURE "arm")
	endif(PACKAGE_ARCHITECTURE STREQUAL "arm" OR PACKAGE_ARCHITECTURE STREQUAL "armv71")
	...
	if(PACKAGE_DISTRIBUTION STREQUAL "Debian" OR PACKAGE_DISTRIBUTION STREQUAL "Ubuntu")
		execute_process(COMMAND lsb_release -sr OUTPUT_VARIABLE DEBIAN_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
		set(CPACK_GENERATOR "DEB;TGZ")
		set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}_${PACKAGE_VERSION_NAME}_${PACKAGE_DISTRIBUTION}_${DEBIAN_VERSION}_${PACKAGE_FILENAME_ARCHITECTURE}")

	elseif(PACKAGE_DISTRIBUTION MATCHES "RedHat.*" OR PACKAGE_DISTRIBUTION STREQUAL "CentOS" OR PACKAGE_DISTRIBUTION STREQUAL "AlmaLinux" OR PACKAGE_DISTRIBUTION STREQUAL "Rocky")
