...
<html lang="en">
  ...
  <body>
    ...
    <!-- Header -->
    <header id="home" class="header h-fullscreen" style="background-image: url(<?php echo get_assets_folder(); ?>/img/bg/abstract.jpg)">
      ...
      <div class="container text-center">
        ...
        <div class="row h-100">
          <div class="col-lg-8 mx-auto align-self-center">
            ...
            <p>
              <a class="btn btn-lg btn-round btn-primary w-200" href="<?php echo get_template_page(PAGE_DOWNLOAD); ?>">Download</a>
			  <a class="btn btn-lg btn-round btn-outline-primary w-200" href="#section-features">Features</a>
			  <br>
			  <span class="color-vanilla-green small-1">Currently v<?php echo LATEST_VERSION; ?></span>
            </p>
