...
<html lang="en">
  ...
  <?php
		...
		add_action('wp_enqueue_scripts', function() {
			wp_enqueue_script('js-contact', get_assets_folder() . '/js/contact.js', null, null, true);
  ...
  <body>
    ...
    <main class="main-content">
      ...
      <section id="section-options" class="section text-center bg-vanilla-light">
        <div class="container">
		  <div class="row gap-y">
			...
			<?php if ( is_active_sidebar( 'widget-poll' ) ): ?>
            <div class="col-lg-2 d-flex">
              <a class="card card-body border text-center hover-shadow-6 text-default" href="#" onclick="PollClick()">
                <p class="my-5"><i class="fa fa-comment lead-8 text-lighter"></i></p>
                <h5>Latest poll</h5>
              </a>
            </div>
			<?php endif; ?>
	  ...
	  !-->
	  <?php if ( is_active_sidebar( 'widget-poll' ) ): ?>
	  <section id="section-poll" class="section">
		<div class="container">
		  <div class="row gap-y">
			<div class="col-md-6 mx-auto">
				<?php dynamic_sidebar( 'widget-poll' ); ?>
			</div>
		  </div>
