...
function PersonalYearsSupport(support, price, purchase_link, support_link) {
    document.getElementById("personal-price").innerHTML = price + '<?php echo PRICE_CURRENCY_SYMBOL; ?>';
...
function CommercialYearsSupport(support, price, purchase_link, support_link) {
    document.getElementById("commercial-price").innerHTML = price + '<?php echo PRICE_CURRENCY_SYMBOL; ?>';
