...
PERSONAL_LICENSE_PRICE =				10 - 1;
PERSONAL_ONE_YEAR_SUPPORT_PRICE =		40 - 1;
PERSONAL_TWO_YEAR_SUPPORT_PRICE =		2 * (24 - 1);
PERSONAL_THREE_YEAR_SUPPORT_PRICE =		3 * (19 - 1);
COMMERCIAL_LICENSE_PRICE =				110 - 1;
COMMERCIAL_ONE_YEAR_SUPPORT_PRICE =		300 - 1;
COMMERCIAL_TWO_YEAR_SUPPORT_PRICE =		2 * (180 - 1);
COMMERCIAL_THREE_YEAR_SUPPORT_PRICE =	3 * (140 - 1);
